...
def main():
    ...
    model = sgl.Engine(
        ...
        num_continuous_decode_steps = 32,
        page_size = 32,
    ...
    for i in tqdm(range(5), desc="Warm Up..."):
        ...
        _ = model.generate(
            prompt=warmup_prompt, sampling_params=sampling_params)
    ...
    for _ in tqdm(range(10), desc="Test Inference"):
        ...
        tput = generated['meta_info']['completion_tokens']/generated['meta_info']['e2e_latency']
