...
class SSM_Eagle(SSMBase):
    ...
    def forward(self, input_ids, hidden_states, embed_tokens, *model_args, **kwargs):
        with torch.no_grad():
    ...
    @torch.no_grad()
    def speculate(self, input_ids, hidden_states, past_key_values, embed_tokens, lm_head):
        """This method is used to draft/guess the next tokens that the LLM may generate.
...
class SSM_SharedKV(SSM_Classic):
    ...
    @torch.no_grad()
    def speculate(self, input_ids, past_key_values, past_key_values_llm, embed_tokens, lm_head):
        """This method is used to draft/guess the next tokens that the LLM may generate.
