...
from ..models import SSM_FSPAD, LLM_First_Layers, LLM_Last_Layers
...
def main(args):
    ...
    if args.pretrained is not None:
        ...
        model = SSM_FSPAD.from_pretrained(args.pretrained, config=draft_config, keep_embeddings=args.keep_embeddings)
    else:
        logger.info("Loading draft model...")
        model = SSM_FSPAD(config=draft_config, keep_embeddings=args.keep_embeddings)
